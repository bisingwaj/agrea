...
export default function AboutPage() {
    ...
    const STATS = [
        { value: t("about.impact_1_val"), label: t("about.impact_1_lbl") },
        { value: t("about.impact_2_val"), label: t("about.impact_2_lbl") },
        { value: t("about.impact_3_val"), label: t("about.impact_3_lbl") },
        { value: t("about.impact_4_val"), label: t("about.impact_4_lbl") },
    ];
    ...
    const VALUES = [
        ...
        { title: t("about.v5_title"), desc: t("about.v5_desc") },
        { title: t("about.v6_title"), desc: t("about.v6_desc") },
    ];

    const METHOD = [
        { title: t("about.method_step1_title"), desc: t("about.method_step1_desc") },
        { title: t("about.method_step2_title"), desc: t("about.method_step2_desc") },
        { title: t("about.method_step3_title"), desc: t("about.method_step3_desc") },
        { title: t("about.method_step4_title"), desc: t("about.method_step4_desc") },
    ];

    const EXPERTS = [
        t("about.exp_1"), t("about.exp_2"), t("about.exp_3"), t("about.exp_4")
    ];
        ...
        <section style={{ paddingBottom: "100px" }}>
                ...
                <div className="container" style={{ position: "relative", zIndex: 1, display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
                    <div style={{ maxWidth: "900px" }}>
                        ...
                        <h1 style={{ marginBottom: "32px", fontSize: "clamp(2.5rem, 5vw, 4.5rem)", lineHeight: "1.1", fontWeight: 600, letterSpacing: "-0.03em" }}>
                            <TextReveal delay={0.2}>{t("about.h1_1")}</TextReveal><br />
                            <TextReveal delay={0.3}><span style={{ color: "var(--text-secondary)", fontWeight: 400 }}>{t("about.h1_2")}</span></TextReveal>
                        </h1>
                        <FadeUp delay={0.5}>
                ...
                <div className="container">
                    <FadeUp delay={0.1}>
                        <div style={{ textAlign: "center", marginBottom: "60px" }}>
                            <span className="label" style={{ display: "block", marginBottom: "16px" }}>{t("about.impact_title")}</span>
                        </div>
                    </FadeUp>
            ...
            <div className="container" style={{ paddingTop: "120px" }}>
                ...
                <div style={{ marginBottom: "160px" }}>
                    <FadeUp delay={0.1}>
                        <div style={{ textAlign: "center", marginBottom: "80px" }}>
                            ...
                            <h2 style={{ fontSize: "40px", fontWeight: 500, letterSpacing: "-0.02em" }}>{t("about.values_title")}</h2>
                        </div>
                    </FadeUp>
                ...
                <div style={{ marginBottom: "160px", padding: "80px", background: "rgba(16, 185, 129, 0.02)", border: "1px solid rgba(16, 185, 129, 0.1)", borderRadius: "24px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "60px", alignItems: "center" }} className="experts-grid">
                    ...
                    <FadeUp delay={0.1}>
                        <div>
                            <span className="label" style={{ display: "block", marginBottom: "16px" }}>{t("about.experts_badge")}</span>
                            <h2 style={{ fontSize: "36px", fontWeight: 500, marginBottom: "24px", color: "var(--white)" }}>{t("about.experts_title")}</h2>
                            <p style={{ fontSize: "18px", color: "var(--text-secondary)", lineHeight: "1.7", marginBottom: "40px" }}>{t("about.experts_desc")}</p>
                        </div>
                    </FadeUp>
                    <StaggerReveal staggerDelay={0.15}>
                ...
                <div style={{ marginBottom: "160px" }}>
                    <FadeUp delay={0.1}>
                        <div style={{ textAlign: "center", marginBottom: "80px" }}>
                            ...
                            <h2 style={{ fontSize: "40px", fontWeight: 500 }}>{t("about.method_title")}</h2>
                        </div>
                    </FadeUp>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "24px" }} className="method-grid">
                            ...
                            {METHOD.map((m, i) => (
                                <div key={i} style={{ padding: "40px 32px", borderTop: "2px solid var(--border)", position: "relative" }}>
                                    ...
                                    <span style={{ fontSize: "14px", fontWeight: 600, color: "var(--green-900)", marginBottom: "24px", display: "block", textTransform: "uppercase" }}>{t("about.method_phase")} 0{i + 1}</span>
                ...
                <div style={{ marginBottom: "140px", textAlign: "center" }}>
                    <FadeUp>
                        <div style={{ maxWidth: "700px", margin: "0 auto 60px auto" }}>
                            ...
                            <h2 style={{ fontSize: "32px", marginBottom: "20px" }}>{t("about.institutions_title")}</h2>
                            <p style={{ color: "var(--text-secondary)" }}>{t("about.institutions_desc")}</p>
                        </div>
                    </FadeUp>
                ...
                <FadeUp delay={0.2}>
                    <div style={{ maxWidth: "600px", margin: "0 auto", padding: "60px", background: "rgba(255,255,255,0.02)", border: "1px solid var(--border)", borderRadius: "24px", textAlign: "center", boxShadow: "0 20px 60px rgba(0, 0, 0, 0.4)" }} className="glow-card">
                        ...
                        <Link href="/contact" style={{ display: "inline-flex", background: "var(--white)", color: "#000", padding: "18px 40px", borderRadius: "100px", fontSize: "16px", fontWeight: 500, textDecoration: "none", transition: "transform 0.2s ease" }} onMouseOver={(e: React.MouseEvent) => (e.currentTarget as HTMLElement).style.transform = "scale(1.05)"} onMouseOut={(e: React.MouseEvent) => (e.currentTarget as HTMLElement).style.transform = "scale(1)"}>
                            {t("about.contact_btn")}
                        </Link>
                    </div>
                </FadeUp>
