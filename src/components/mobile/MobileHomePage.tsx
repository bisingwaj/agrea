...
import {
    ...
    GraduationCap, ChevronRight, ArrowRight, Briefcase
} from "lucide-react";

const iconMap: Record<string, React.ElementType> = {
    Building2, Mountain, Leaf, Truck, Zap, Monitor,
    Stethoscope, ShoppingCart, Landmark, Factory, Utensils, GraduationCap, Briefcase
};
    ...
    return (
        <FadeUp delay={0.4}>
            <section style={{ padding: `0 0 64px` }}>
                ...
                {/* Bloc Création (Nouveau projet) */}
                <div style={{ padding: `0 ${PX} 32px` }}>
                    <Link href={`/${creationSector.id}`} style={{ display: "flex", alignItems: "center", gap: "16px", padding: "20px", background: "linear-gradient(135deg, rgba(16, 185, 129, 0.1) 0%, rgba(16, 185, 129, 0.02) 100%)", border: "1px solid rgba(16, 185, 129, 0.2)", borderRadius: "16px", textDecoration: "none", overflow: "hidden", position: "relative" }}>
                        <div style={{ width: "48px", height: "48px", borderRadius: "14px", background: "rgba(16, 185, 129, 0.15)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                            <Briefcase size={24} color="var(--green-900)" strokeWidth={1.5} />
                        </div>
                        <div style={{ flexGrow: 1 }}>
                            <span style={{ fontSize: "10px", textTransform: "uppercase", letterSpacing: "0.1em", color: "var(--green-900)", fontWeight: 700, display: "block", marginBottom: "4px" }}>{t("home.sectors_label")}</span>
                            <h3 style={{ fontSize: "18px", color: "var(--white)", fontWeight: 500, marginBottom: "4px" }}>{t(`sectors.${creationSector.id}.name` as any)}</h3>
                            <p style={{ fontSize: "13px", color: "var(--text-secondary)", lineHeight: "1.4" }}>{t(`sectors.${creationSector.id}.desc` as any)}</p>
                        </div>
                        <div style={{ width: "28px", height: "28px", borderRadius: "50%", background: "var(--green-900)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                            <ChevronRight size={16} color="var(--white)" />
                        </div>
                    </Link>
                </div>
                ...
                <div style={{ padding: `0 ${PX} 16px` }}>
                    <h3 style={{ fontSize: "18px", fontWeight: 500, color: "var(--white)" }}>{t("home.sectors_title_short")}</h3>
                </div>
